...
//general variables
$global_channel_name="ojoVoz";
$channel_folder="your_folder";
$init_page="prueba.php";
$main_page="prueba.php";
$master_pass="ojovoz";
...
//
$mail_server="{IP_address_of_your_mail_server:110/pop3/notls}";
...
//android
$smtp_server="address_of_your_smtp_server";
$smtp_server_port="smtp_server_port";
$multimedia_subject="xxxxx";
//RSS
$rss_description="ojoVoz test";
$rss_language="en";
$rss_max_messages=50;
?>
